# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2018-03-04 18:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(blank=True, choices=[('fl oz', 'Fluid Ounce')], db_index=True, help_text='Units associated with the <code>Value</code> field.', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time_stamp', models.DateTimeField(db_index=True, help_text='When the metric event occurred or began.')),
                ('type', models.CharField(choices=[('gym', 'Gym'), ('run', 'Run'), ('steps', 'Steps')], db_index=True, help_text='The type of meal eaten.', max_length=10)),
                ('value', models.FloatField(blank=True, db_index=True, help_text='The recorded value for the type of exercise.', null=True)),
                ('units', models.CharField(blank=True, choices=[('steps', 'Steps'), ('miles', 'Miles')], db_index=True, help_text='Units associated with the <code>Value</code> field.', max_length=10, null=True)),
                ('alone', models.BooleanField(db_index=True, default=True, help_text='Whether metric event occurred while being alone.')),
                ('notes', models.TextField(blank=True, help_text='Any extra notes associated with metric event.', null=True)),
                ('user', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
